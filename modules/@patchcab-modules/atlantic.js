...
/* src/TIDE_ACNJ.svelte generated by Svelte v3.31.2 */
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(() => __awaiter(void 0, void 0, void 0, function* () {
		try {
			...
			let fetchUrl = `http://www.ioc-sealevelmonitoring.org/service.php?query=data&format=json&code=${"acnj"}&includesensors[]=wls&timestop=now&timestart=`;
			let today = new Date();
			let minute = 60 * 1000;
...
class TIDE_ACNJ extends __sv.SvelteComponent {
	constructor(options) {
		super();
