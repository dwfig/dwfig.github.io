...
/* src/TIDE_BTNY.svelte generated by Svelte v3.31.2 */
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(() => __awaiter(void 0, void 0, void 0, function* () {
		try {
			...
			let fetchUrl = `http://www.ioc-sealevelmonitoring.org/service.php?query=data&format=json&code=${"btny"}&includesensors[]=pwl&timestop=now&timestart=`;
			let today = new Date();
			let minute = 60 * 1000;
			...
			let query = `${fetchUrl}${dateQuery}`;
			console.log(query);

			const res = yield fetch(corsProxy + query, {
				method: "GET",
...
class TIDE_BTNY extends __sv.SvelteComponent {
	constructor(options) {
		super();
