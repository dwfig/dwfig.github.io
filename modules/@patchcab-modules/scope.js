...
import { Faceplate, onMount, Switch, Patch, scale } from '/js/core.js';
...
// (100:0) <Faceplate title="SCOPE" color="var(--color-3)">
function create_default_slot(ctx) {
	...
	switch_1 = new Switch({
			props: {
				...
				x: 84,
				y: 260,
				value: /*state*/ ctx[0].internalTrigger,
				onToggle: /*toggleTrigger*/ ctx[4]
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*state*/ 1) switch_1_changes.value = /*state*/ ctx[0].internalTrigger;
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, state, canvas*/ 32771) {
...
function instance($$self, $$props, $$invalidate) {
	...
	let { state = { internalTrigger: false } } = $$props;
	...
	const toggleTrigger = () => {
		$$invalidate(0, state.internalTrigger = !state.internalTrigger, state);
	};
	...
	return [state, canvas, node, onConnect, toggleTrigger, canvas_1_binding];
}
